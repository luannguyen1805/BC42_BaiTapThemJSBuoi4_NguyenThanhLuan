...
document.getElementById("yesterday").onclick = function () {
    ...
    let result = document.getElementById("resultBai1");
    if (!(day > 0 && day <= 31)) {
...
document.getElementById("reset4").onclick = function () {
    ...
    document.getElementById("toaDoX1").value = "";
    document.getElementById("toaDoY1").value = "";
    document.getElementById("name2").value = "";
    document.getElementById("toaDoX2").value = "";
    document.getElementById("toaDoY2").value = "";
    document.getElementById("name3").value = "";
    document.getElementById("toaDoX3").value = "";
    document.getElementById("toaDoY3").value = "";
    document.getElementById("toaDoTruongX").value = "";
    document.getElementById("toaDoTruongY").value = "";
